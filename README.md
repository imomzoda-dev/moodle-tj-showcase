...
Поиск по названию, фильтры по категории, уровню и языку курса —
у каждого языка свой флаг и число курсов. На карточке видно уровень,
автора, длительность, число студентов и выдаётся ли сертификат.
...
Преподаватель, длительность, число студентов и уроков. Отдельная
плашка показывает, сколько уроков осталось до сертификата, а автору
курса — быстрый переход к активности, урокам и редактированию.
...
Чат для всех: сообщения группируются по дням, есть ответы на реплики,
картинки, эмодзи и правка отправленного. Открывается поверх любой
страницы и не мешает читать урок.

<img src="docs/screenshots/19-chat.png" alt="Общий чат платформы">
...
Одно поле ищет по курсам, урокам и новостям сразу. Результаты
разложены по разделам, найденное слово подсвечено, под каждым
уроком видно, из какого он курса.

<img src="docs/screenshots/20-search.png" alt="Глобальный поиск">
...
| Общий чат | Чат платформы: ответы на сообщения, картинки, эмодзи, правка |
